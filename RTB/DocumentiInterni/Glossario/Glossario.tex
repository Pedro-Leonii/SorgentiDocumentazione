...
\newglossaryentry{Pull reques}{
    name=Pull reques,
    description={Un pull request è un meccanismo di collaborazione in cui uno sviluppatore propone modifiche al codice, 
...
\newglossaryentry{Agile}{
    ...
    description={Agile in informatica è un insieme di metodologie e pratiche di sviluppo software che promuovono iterazioni
     rapide, adattabilità ai cambiamenti e una stretta collaborazione tra team di sviluppo e clienti. Il termine Agile si
...
\begin{registromodifiche}
        v0.1 & 19 dicembre 2024  & Francesco Savio & & Sezioni \hyperref[sec:introduzione]{Introduzione},  \hyperref[sec:glossario]{Glossario}\\
    \hline 
