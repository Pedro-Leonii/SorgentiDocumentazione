...
\newglossaryentry{PoC}{
    name=PoC,
    description={Il PoC (proof of concept) è una realizzazione incompleta di un determinato progetto o metodo per dimostrare la fattibilità o 
...
\newglossaryentry{End value}{
    name=End value,
    description={L'end value rappresenta il valore finale stimato di un progetto al completamento.
    }
}

\newglossaryentry{Python}{
    name=Python,
    description={Python è un linguaggio di programmazione interpretato, dinamico e ad alto livello, caratterizzato da una sintassi chiara e leggibile.
    }
}

\newglossaryentry{Angular}{
    name=Angular,
    description={Angular è un framework open-source per lo sviluppo di applicazioni web single-page (SPA) e front-end.
    }
}

\newglossaryentry{IEEE 828}{
    name=IEEE 828,
    description={L'IEEE 828 è uno standard che stabilisce le linee guida per la gestione della configurazione software nei progetti di 
...
\newglossaryentry{Javascript}{
    name=Javascript,
    description={Javascript è un linguaggio di programmazione interpretato, dinamico e orientato agli oggetti, utilizzato principalmente 
    per lo sviluppo di applicazioni web interattive.
    }
}

\newglossaryentry{Budget at Completion}{
    name=Budget at Completion,
    description={Il budget at completion (BAC) è una metrica utilizzata nella gestione dei progetti per rappresentare il costo totale 
...
\newglossaryentry{Ciclo di Deming}{
    ...
    description={Il ciclo di Deming (PDCA) è un metodo di gestione iterativo in quattro fasi utilizzato per il controllo e il miglioramento 
...
\newglossaryentry{Aspell}{
    name=Aspell,
    description={Aspell è un correttore ortografico open-source che è stato impiegato nella creazione della GitHub action per il controllo 
...
\newglossaryentry{Analisi dinamica}{
    ...
    description={L'analisi statica è una tecnica di valutazione del software eseguita durante l'esecuzione del programma. Monitora 
...
\newglossaryentry{Analisi statica}{
    ...
    description={L'analisi statica è una tecnica di valutazione del software che viene eseguita senza l'esecuzione del programma. Si basa 
...
\newglossaryentry{TLShell}{
    name=TLShell,
    description={TLShell è un'interfaccia grafica per TeX Live, una delle distribuzioni più utilizzate di LaTeX. Viene fornita con TeX Live per 
...
\newglossaryentry{Walkthrough}{
    name=Walkthrough,
    description={Il walkthrough è una tecnica di revisione per analizzare e migliorare la qualità di un documento, di un codice sorgente o di un sistema. 
...
\newglossaryentry{Ciclo di vita}{
    name=Ciclo di vita,
    description={Il ciclo di vita rappresenta l'insieme delle fasi attraverso cui un prodotto software viene ideato, sviluppato, distribuito e mantenuto nel tempo. 
    }
}

\newglossaryentry{Requisiti software}{
    name=Requisiti utente,
    description={I requisiti software definiscono le caratteristiche, le funzionalità e i vincoli che un sistema software deve soddisfare per rispondere alle necessità degli 
...
\newglossaryentry{Requisiti utente}{
    name=Requisiti utente,
    description={I requisiti utente sono una categoria di requisiti software che descrivono le necessità, gli obiettivi e le aspettative degli utenti 
...
\newglossaryentry{API REST}{
    name=API REST,
    description={API REST (Application Programming Interface basata su Representational State Transfer) è un'interfaccia che consente la comunicazione tra 
...
\newglossaryentry{Large Language Model}{
    ...
    description={Un Large Language Model (LLM) è un modello di intelligenza artificiale basato su reti neurali profonde, addestrato su vasti insiemi di 
...
\newglossaryentry{Mock}{
    name=Mock,
    description={Un mock è un oggetto simulato che replica il comportamento di un componente software reale per scopi di test.
    }
}

\newglossaryentry{Indice di Gulpease}{
    name=Indice di Gulpease,
    description={L'indice di Gulpease è una metrica di leggibilità progettata per la lingua italiana che misura la facilità di comprensione di un testo 
...
\newglossaryentry{Containerizzazione}{
    ...
    description={La containerizzazione è una tecnica di virtualizzazione a livello di sistema operativo che consente di eseguire applicazioni in 
...
\newglossaryentry{Obiettivi di qualità}{
    ...
    description={Gli obiettivi di qualità rappresentano i criteri misurabili che un sistema software deve soddisfare per garantire prestazioni, 
...
\newglossaryentry{Requisiti funzionali}{
    ...
    description={I requisiti funzionali definiscono le funzionalità e i comportamenti che un sistema software deve implementare per soddisfare le esigenze 
...
\newglossaryentry{Minimum Viable Product}{
    ...
    description={Il Minimum Viable Product (MVP) è una prima versione di un prodotto che include solo le funzionalità essenziali per offrire ciò 
...
\newglossaryentry{Rischio tecnologico}{
    ...
    description={Il rischio tecnologico indica la possibilità che un'organizzazione subisca perdite economiche, inefficienze o interruzioni durante 
    lo sviluppo a causa di problemi legati alla scelta, l'uso, la sicurezza o la mancanza di supporto delle tecnologie utilizzate. Il rischio puo anche 
...
\newglossaryentry{Rischio organizzativo}{
    ...
    description={Il rischio organizzativo indica qualsiasi cosa possa generare insicurezze all'interno di un organizzazione. Esso puo compromettere il 
    raggiungimento degli obiettivi strategici, operativi o di conformità. Questo tipo di rischio viene associato ad inefficienze nei processi decisionali, 
    mancanza di coordinamento tra componenti organizzativi o problemi gestionali.
    }
}

\newglossaryentry{Estimated at Completion}{
    name=Estimated at Completion,
    description={L'Estimated at Completion (EAC) è una metrica utilizzata nella gestione dei progetti per stimare il costo totale previsto al 
...
\newglossaryentry{Cost Variance}{
    name=Cost Variance,
    description={La Cost Variance (CV) è una metrica che misura la differenza tra il valore del lavoro svolto e il costo effettivamente sostenuto 
...
\newglossaryentry{Schedule Variance}{
    ...
    description={La Schedule Variance (SV) è una metrica che misura la differenza tra il valore del lavoro pianificato e il valore del lavoro 
...
\newglossaryentry{Actual Cost}{
    name=Actual Cost,
    description={L'Actual Cost (AC) rappresenta il costo effettivamente sostenuto per completare il lavoro in un determinato momento o fase di un 
...
\newglossaryentry{Earned Value}{
    name=Earned Value,
    description={l'Earned Value (EV) rappresenta il valore del lavoro effettivamente completato in un determinato momento o fase di un progetto. L'EV viene 
...
\newglossaryentry{Planned Value}{
    name=Planned Value,
    description={Il Planned Value (PV) rappresenta il valore pianificato del lavoro che dovrebbe essere completato in un determinato momento o fase 
...
\newglossaryentry{Risk Mitigation Rate}{
    name=Risk Mitigation Rate,
    description={il Risk Mitigation Rate (RMR) è una metrica che misura l'efficacia delle azioni intraprese per mitigare i rischi identificati 
...
\newglossaryentry{Cruscotto di valutazione}{
    ...
    description={Il cruscotto di valutazione è uno strumento che fornisce una visualizzazione delle metriche 
...
\newglossaryentry{Metriche}{
    name=Metriche,
    description={Le metriche sono valori utilizzati per valutare e monitorare diverse caratteristiche del processo 
...
\newglossaryentry{Design Pattern}{
    name=Design Pattern,
    description={Un design pattern è una soluzione generale e riutilizzabile a un problema comune nella progettazione del software. Non è un design 
...
\newglossaryentry{Quality Assurance}{
    ...
    description={Quality Assurance (QA) si riferisce all'insieme delle attività pianificate e sistematiche implementate per assicurare che un prodotto 
...
\newglossaryentry{Fork}{
    name=Fork,
    description={Fork è una copia di un repository di codice sorgente che consente a uno sviluppatore di apportare modifiche al codice senza 
...
\newglossaryentry{Pipeline}{
    name=Pipeline,
    description={Una pipeline è un insieme di processi automatizzati che vengono eseguiti in sequenza per costruire, testare e distribuire il software. 
...
\newglossaryentry{Draw.io}{
    name=Draw.io,
    description={Draw.io è un software online gratuito e open source per la creazione di diagrammi di vario tipo, è stato usato dal gruppo per la cleazione 
    di diagrammi UML.   
    }
}
...
\newglossaryentry{Cerimonie}{
    name=Cerimonie,
    description={le cerimonie sono eventi formali e predefiniti che si svolgono durante il ciclo di vita del progetto per favorire la comunicazione, 
...
\newglossaryentry{Artefatti}{
    name=Artefatti,
    description={Gli artefatti sono i sottoprodotti del processo di sviluppo software. Sono i prodotti tangibili e intangibili creati durante lo 
...
\newglossaryentry{SCRUM}{
    name=SCRUM,
    description={Scrum è un framework di gestione di progetti Agile che si concentra sulla collaborazione di team, sulla definizione di obiettivi chiari 
...
\newglossaryentry{Nomic}{
    name=Nomic,
    description={Nomic Embedding sono rappresentazioni vettoriali (embedding) di dati ad alta dimensione. L'obiettivo principale è rendere 
