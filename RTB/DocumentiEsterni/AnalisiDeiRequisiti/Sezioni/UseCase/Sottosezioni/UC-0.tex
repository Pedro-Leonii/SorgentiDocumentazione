...
\begin{usecase}{UC-0}{Visualizzazione del contenuto di un dataset}
    ...
    \post{
        \item Viene visualizzato il contenuto del dataset
    }
    ...
    \trigger{L'utente deve visualizzare il contenuto del dataset}
