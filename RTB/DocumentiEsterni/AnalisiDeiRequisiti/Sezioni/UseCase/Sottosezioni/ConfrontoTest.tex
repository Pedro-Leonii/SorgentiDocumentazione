...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.2]{Sezioni/UseCase/Immagini/ConfrontoTest.png}
...
\begin{usecase}{UC-45}{Confronta test salvati}
    ...
    \pre{
        ...
        \item Il test caricato condivide il dataset e/o l'LLM usati nel test con almeno un altro test salvato
    }
...
\begin{usecase}{UC-48}{Cambia pagina confronto singoli risultati}
    ...
    \subscenario{
        \item[2.1] La pagina richiesta non è valida ovvero è minore di uno o maggiore della pagina massima:
        \begin{itemize}
