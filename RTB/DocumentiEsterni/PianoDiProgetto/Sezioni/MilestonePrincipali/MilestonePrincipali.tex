...
\begin{table}[!h]
    ...
    \begin{tabular}{| l | l | l | l |}
        ...
        \hline 
            \textbf{Totale} & \textbf{184} & \textbf{N/A} & \textbf{3970€} \\ 
        \hline  
    \end{tabular}}
...
\begin{figure}[!h]
    \centering
    \begin{tikzpicture}
        \pie{13.04/Responsabile, 10.87/Amministratore, 38.04/Analista, 21.74/Programmatore, 16.30/Verificatore}
    \end{tikzpicture}
