...
eccessivo per ogni sprint portando ad un numero elevato di attività non completate, per mancanza di tempo e di impengo da parte del gruppo.
Questo ha portato alla necessità di spostare in avanti la data per RTB inizalmente previssata per completare, durante gli ultimi sprint, le attività precedentemente pianficate.
